...
CREATE TABLE `points_params` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `point_id` int(11) NOT NULL,
  `name` enum('name msgPattern','msgHeaderPattern','msgIpPattern','msgTextPattern','dateFormat','dateDiffFormat','wait','tries','timeout','showIp') COLLATE utf8mb4_unicode_ci NOT NULL,
